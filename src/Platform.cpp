// FIX: On Windows/Visual Studio, the include is just <SDL.h>
// On Linux it would be <SDL2/SDL.h> — the difference is how
// the include directories are configured on each platform.
